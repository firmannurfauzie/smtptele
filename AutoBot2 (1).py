...
TELEGRAM_ACCESS_TOKEN = "2068079532:AAFZQDOVrFs4pW_j59JeymChEK0K5tcIL-0"
USER_ID = "1123476832"
...
class GrabAnything:
    ...
    def value(self, raw_name, *args, **kwargs):
        ...
        if name:
            ...
            value_ = name2.findNext(text=True)
            if value_:
                return self.valid(value_.string)

            sf_dump = name.findNext(class_="sf-dump-str")
            if sf_dump:
                return self.valid(sf_dump.text)
